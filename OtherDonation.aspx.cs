...
public partial class Donor_OtherDonation : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    String strCon, isql;
    ...
    protected void btnDonate_Click(object sender, EventArgs e)
    {
        ...
        fpath = "~\\Images\\" + fname;
        isql = "INSERT INTO OTHERDONATION(Did, Donationtype, Donationdesc, DonationImage, PickupLocation) VALUES('"
            + txtID.Text + "','"
            + txtFoodType.Text + "','"
            + txtDesc.Text + "','"
            + fpath + "','"
