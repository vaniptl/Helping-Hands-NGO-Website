...
public partial class Admin_ManageVolunteer : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    ...
    {
        usql = "UPDATE Volunteer  SET Fullname=' " + txtname.Text + "', Address='" + txtAddress.Text + "',ContactNo='" + txtContact.Text + "' where Vid=" + drpVolunteerID.SelectedValue;
    ...
    protected void drpVolunteerID_SelectedIndexChanged(object sender, EventArgs e)
    {
        ssql = "select Fullname,Address,ContactNo from Volunteer where Vid=" + drpVolunteerID.SelectedValue;
    ...
    {
        dsql = "delete from volunteer where Vid=" + drpVolunteerID.SelectedValue;
